...
async function onChooseAttach($event) {
...
function undoDelete(myFile) {
    ...
    form.deleted_file_ids.push = form.deleted_file_ids.filter(id => myFile.id !== id);
}
                    ...
                    <div class="flex min-h-full items-center justify-center p-4 text-center">
                        <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                            ...
                            <DialogPanel
                                ...
                                <DialogTitle as="h3"
                                    class="flex items-center justify-between py-3 px-4 font-medium bg-blue-100 text-gray-900">
                                ...
                                <div class="p-4">
                                    ...
                                    <div v-if="showExtensionsText" class="border-l-4 border-sky-500 py-2 px-3 bg-sky-100 mt-3 text-gray-800">
                                        File format: <br>
                                    ...
                                    <div
                                        ...
                                        <div v-for="(myFile, ind) of computedAttachments">
                                            <div
                                                class="group aspect-square bg-gray-100 flex flex-col items-center justify-center text-gray-500 relative border-2"
                                                :class="attachmentError[ind] ? 'border-red-500' : ''">
                                            ...
                                            <small class="text-red-500">{{ attachmentError[ind] }}</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-2 py-3 px-4">
                                    <button type="button"
                                        class="flex items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 w-full relative"
                                        @click="submit">
                                        <PaperClipIcon class="w-4 h-4 mr-2" />
                                        Attach
                                        <input @click.stop @change="onChooseAttach" type="file" multiple
                                            class="absolute left-0 top-0 right-0 bottom-0 opacity-0" />
                                    </button>
                                    <button type="button"
                                        class="flex items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 w-full"
                                        @click="submit">
