...
<template>
    <div class="p-4 bg-white rounded-lg border mb-3">
        <div @click="postCreating = true" class="py-3 px-2 text-gray-400 border border-2 border-blue-200 rounded mb-3">
            Click here to create post
        </div>
        <div v-if="postCreating" class="flex gap-2 justify-between">
            <button type="submit" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 relative">
                Attach file
