            ...
            <Dialog as="div" @close="closeModal" class="relative z-50">
                ...
                <div class="fixed left-0 top-0 bottom-0 right-0 inset-0 overflow-y-auto">
                    <div class="h-screen w-screen">
                        <TransitionChild as="template" class="h-full w-full" enter="duration-300 ease-out"
                            ...
                            <DialogPanel
                                ...
                                <button @click="closeModal"
                                    class="absolute right-3 top-3 w-10 h-10 rounded-full hover:bg-black/10 transition flex items-center justify-center text-black z-40">
